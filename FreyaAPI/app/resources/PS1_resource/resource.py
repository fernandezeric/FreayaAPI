...
class ResourcePS1():
    ...
    """       
    def get_lc_deg(self):
        data_method = DataLcDegree(catalog='PS1',ra=self.ra,dec=self.dec,radius=self.radius,format=self.format,nearest=self.nearest).get_data()
        return data_method
    ...
    """
    def get_lc_hms(self):
        data_method = DataLcHms(catalog='PS1',hms=self.hms,radius=self.radius,format=self.format,nearest=self.nearest).get_data()
        return data_method
